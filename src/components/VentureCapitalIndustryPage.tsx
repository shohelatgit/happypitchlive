...
const services = [
  {
    title: 'Pitch Decks',
    description: 'Compelling fund presentations that articulate your thesis and convince LPs to invest in your next fund.',
    icon: Presentation
  },
  {
    title: 'Fund Marketing',
    description: 'Professional marketing materials that showcase your track record and attract institutional investors.',
    icon: Briefcase
  },
  {
    title: 'Portfolio Updates',
    description: 'Clear and impactful portfolio performance reports that keep LPs informed and confident.',
    icon: FileText
  },
  {
    title: 'Investment Memos',
    description: 'Thorough investment memos that support your thesis and demonstrate rigorous due diligence.',
    icon: Building2
  },
  {
    title: 'Board Materials',
    description: 'Professional board presentations that communicate strategy, performance, and key decisions.',
    icon: Users
  },
  {
    title: 'LP Reports',
    description: 'Detailed LP reporting materials that build trust and maintain strong investor relationships.',
    icon: TrendingUp
  }
];
...
export const VentureCapitalIndustryPage = () => {
    ...
    <div style={{
      ...
      <section style={{
        ...
        <div style={{
          ...
          <span style={{
            ...
            Compelling presentations that help VC firms articulate their thesis, showcase their portfolio, and raise the next flagship fund.
          </span>
          <button style={{
            width: 'auto',
            height: 'auto',
      ...
      <section style={{
        ...
        <div style={{
          ...
          <FeatureCard
            title="Fund Thesis Excellence"
            description="Marketing and investor materials that articulate your investment thesis with clarity and conviction."
            icon={Search}
          />
          <FeatureCard
            title="Portfolio Performance"
            description="Get reports and materials that communicate returns, value creation, and strategic outcomes."
            icon={FileText}
          />
          <FeatureCard
            title="LP Relationship Building"
            description="From fund launches to ongoing reporting. Build materials that strengthen investor relationships."
            icon={Palette}
          />
        </div>
      </section>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <h3 style={{
                ...
                In venture capital, your deck is your first portfolio company
              </h3>
              <p style={{
                color: 'rgba(124, 124, 124, 1)',
                fontSize: '16px',
                ...
                LP investors look for conviction and clarity. Your fund materials should communicate why you're the right partner for their capital.
              </p>
              <button style={{
                width: 'auto',
                height: 'auto',
      ...
      <section style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            Turn Your Thesis Into Presentations That Close
          </h2>
          <p style={{
            color: 'rgba(124, 124, 124, 1)',
            fontSize: '18px',
            ...
            Top VC firms that backed unicorns. GPs that built legendary funds. When the stakes are high, sophisticated firms choose materials that actually work.
          </p>
        </div>
        <div style={{
          display: 'grid',
          ...
          {[
            {
              ...
              items: ['Market Thesis Research', 'Sector Deep Dives', 'Portfolio Analysis', 'Competition Assessment'],
              icon: Search,
              color: '#3b82f6',
            ...
            },
            {
              ...
              items: ['Investment Thesis Development', 'Fund Differentiation', 'Value Add Narrative', 'LP Targeting Strategy'],
              icon: Lightbulb,
              color: '#f97316',
            ...
            },
            {
              ...
              items: ['Pitch Deck Creation', 'Fund Overview Documents', 'Data Visualization', 'Print-Ready Materials'],
              icon: Palette,
              color: '#a855f7',
