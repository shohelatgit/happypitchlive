...
const services = [
  {
    title: 'Pitch Decks',
    description: 'Investor-ready pitch decks that articulate your digital solutions with clarity and impact.',
    icon: Presentation
  },
  {
    title: 'Solution Presentations',
    description: 'Compelling presentations that demonstrate your technology value to enterprise buyers.',
    icon: FileText
  },
  {
    title: 'Case Studies',
    description: 'Impactful case studies that showcase measurable outcomes and customer success stories.',
    icon: Briefcase
  },
  {
  ...
  },
  {
    ...
    description: 'B2B sales materials that articulate value proposition and accelerate buying cycles.',
    icon: TrendingUp
  },
  {
    title: 'Product Demos',
    description: 'Polished demo materials and scripts that bring your digital solutions to life.',
    icon: Users
  }
];
...
export const DigitalTransformationIndustryPage = () => {
      ...
      <section style={{
        ...
        <div style={{
          ...
          <h1 style={{
            ...
            Enterprise Tech Presentations That Drive Adoption
          </h1>
          <span style={{
            color: 'rgba(124, 124, 124, 1)',
            fontSize: '18px',
            ...
            Compelling materials that help technology companies articulate their digital solutions and win enterprise deals.
          </span>
          <button style={{
            width: 'auto',
            height: 'auto',
      ...
      <section style={{
        ...
        <div style={{
          ...
          <FeatureCard
            ...
            description="Marketing and sales materials that communicate your technology value effectively."
            icon={Search}
          />
          <FeatureCard
            title="ROI Demonstration"
            description="Get presentations and reports that prove value with data and measurable outcomes."
            icon={FileText}
          />
          <FeatureCard
            title="Implementation Excellence"
            description="From pitch decks to board materials. Enterprise-ready collateral for every stage."
            icon={Palette}
          />
        </div>
      </section>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <h3 style={{
                ...
                In enterprise tech, your pitch is your product's first impression
              </h3>
              <p style={{
                color: 'rgba(124, 124, 124, 1)',
                fontSize: '16px',
                ...
                Enterprise buyers expect materials that demonstrate value, reduce risk, and showcase measurable outcomes. Make your case with confidence.
              </p>
              <button style={{
                width: 'auto',
                height: 'auto',
      ...
      <section style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            Turn Your Technology Into Presentations That Close
          </h2>
          <p style={{
            color: 'rgba(124, 124, 124, 1)',
            fontSize: '18px',
            ...
            Enterprise tech leaders that won major contracts. Companies that transformed industries. When the stakes are high, sophisticated firms choose materials that actually work.
          </p>
        </div>
        <div style={{
          display: 'grid',
          ...
          {[
            {
              ...
              items: ['Market Opportunity Analysis', 'Competitor Assessment', 'Customer Research', 'Industry Trends'],
              icon: Search,
              color: '#3b82f6',
            ...
            },
            {
              ...
              items: ['Value Proposition Development', 'Market Positioning', 'Messaging Framework', 'Customer Journey Mapping'],
              icon: Lightbulb,
              color: '#f97316',
            ...
            },
            {
              ...
              items: ['Pitch Deck Creation', 'Solution Visualizations', 'Case Study Design', 'Demo Materials'],
              icon: Palette,
              color: '#a855f7',
