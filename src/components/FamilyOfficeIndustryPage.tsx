...
const services = [
  {
    ...
    description: 'Comprehensive investment memos that articulate your thesis, demonstrate track record, and build confidence with co-investors.',
    icon: FileText
  },
  {
    title: 'Co-Investment Presentations',
    description: 'Polished presentations designed for co-investors and institutional partners that communicate investment opportunity with clarity.',
    icon: Presentation
  },
  {
  ...
  },
  {
    ...
    description: 'Investor updates that maintain transparency and reinforce trust with your limited partners and advisors.',
    icon: Building2
  },
  {
    title: 'Asset Reports',
    description: 'Detailed asset reports and portfolio communications that demonstrate performance and strategic thinking.',
    icon: Briefcase
  },
  {
    title: 'Due Diligence',
    description: 'Due diligence materials that present your investment process with the sophistication institutional partners expect.',
    icon: TrendingUp
  }
];
...
export const FamilyOfficeIndustryPage = () => {
      ...
      <section style={{
        ...
        <div style={{
          ...
          <h1 style={{
            ...
            Sophisticated Communications for Wealth Preservation
          </h1>
          <span style={{
            color: 'rgba(124, 124, 124, 1)',
            fontSize: '18px',
            ...
            Discreet, polished presentations that help family offices communicate with advisors, co-investors, and institutional partners.
          </span>
          <button style={{
            width: 'auto',
            height: 'auto',
          ...
          <div style={{
            ...
            <div style={{
              ...
              <h3 style={{
                ...
                In family office investing, discretion and clarity go hand in hand
              </h3>
              <p style={{
                color: 'rgba(124, 124, 124, 1)',
                fontSize: '16px',
                ...
                Family offices expect materials that reflect the sophistication of their wealth management approach. Your communications should inspire confidence.
              </p>
              <button style={{
                width: 'auto',
                height: 'auto',
      ...
      <section style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            Turn Your Investment Vision Into Presentations That Close
          </h2>
          <p style={{
            color: 'rgba(124, 124, 124, 1)',
            fontSize: '18px',
            ...
            Leading family offices that made strategic investments. Multi-generational wealth managers that built lasting partnerships. When the stakes are high, sophisticated firms choose materials that actually work.
          </p>
        </div>
        <div style={{
          display: 'grid',
          ...
          {[
            {
              ...
              items: ['Investment Opportunity Research', 'Market Analysis', 'Risk Assessment', 'Due Diligence Support'],
              icon: Search,
              color: '#3b82f6',
            ...
            },
            {
              ...
              items: ['Investment Thesis Development', 'Portfolio Strategy', 'Value Creation', 'Stakeholder Alignment'],
              icon: Lightbulb,
              color: '#f97316',
            ...
            },
            {
              ...
              items: ['Investment Memos', 'Data Visualization', 'Brand Materials', 'Print-Ready Materials'],
              icon: Palette,
              color: '#a855f7',
