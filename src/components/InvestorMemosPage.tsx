...
export const InvestorMemosPage = () => {
    ...
    <div style={{
      ...
      <section style={{
        ...
        <div style={{
          ...
          <h1 style={{
            ...
            Investor Memos That Build Confidence
          </h1>
          <span style={{
            color: 'rgba(124, 124, 124, 1)',
            fontSize: '18px',
            ...
            Investment memos that articulate your thesis, demonstrate track record, and build confidence with LPs.
          </span>
          <button style={{
            width: 'auto',
            height: 'auto',
      ...
      <section style={{
        ...
        <div style={{
          ...
          <FeatureCard
            title="LP-Focused Content"
            description="Investment memos written specifically for Limited Partners, addressing their due diligence requirements and decision-making criteria."
            icon={Building2}
          />
          <FeatureCard
            title="Track Record Proof"
            description="Documentation that showcases your historical performance with clarity and credibility."
            icon={Search}
          />
          <FeatureCard
            title="Investment Thesis Clarity"
            description="Clear articulation of your strategy, edge, and why your approach will continue to generate returns."
            icon={Lightbulb}
          />
          <FeatureCard
            title="Professional Standards"
            description="Institutional-quality documentation that reflects the sophistication of your firm."
            icon={Palette}
          />
        </div>
      </section>
      ...
      <section style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            Turn Your Investment Story Into Compelling Documentation
          </h2>
          <p style={{
            color: 'rgba(124, 124, 124, 1)',
            fontSize: '18px',
            ...
            Professional investment memos that help LPs understand your strategy, appreciate your track record, and commit capital with confidence.
          </p>
        </div>
        <div style={{
          display: 'grid',
          ...
          {[
            {
              title: 'Research',
              desc: 'Deep market intelligence to support your investment thesis and strategy.',
            ...
            {
              title: 'Strategy',
              desc: 'Investment thesis development and positioning that demonstrates your edge.',
            ...
            {
              title: 'Design',
              desc: 'Professional documentation that reflects institutional quality.',
      ...
      <section style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Investment memos that helped funds raise capital from sophisticated LPs.
          </p>
        </div>
        <div style={{
          width: '100%',
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{
                ...
                Happy Pitch's investment memo transformed our LP fundraising. They captured our investment thesis perfectly and helped us articulate our unique edge in a way that resonated with institutional investors.
              </p>
              <div style={{
                display: 'flex',
                flexDirection: 'column',
                ...
                <span style={{
                  ...
                  Managing Partner, Summit Capital
                </span>
              </div>
            </div>
            <div style={{
      ...
      <section style={{
        ...
        <FAQItem
          question="What types of funds do you work with?"
          answer="We work with private equity firms, hedge funds, venture capital funds, growth equity funds, and family offices across various strategies and sectors."
        />
        <FAQItem
          question="How detailed are your investment memos?"
          answer="Our investment memos are comprehensive documents that cover investment thesis, strategy, team, track record, market opportunity, and terms. They can be customized to LP preferences."
        />
        <FAQItem
          question="Can you help with ongoing investor relations materials?"
          answer="Yes, we provide ongoing support for quarterly reports, fund updates, and other investor communications."
        />
        <FAQItem
          question="What makes your memos stand out?"
          answer="We combine deep strategy expertise with institutional design standards to create memos that effectively communicate your value proposition to sophisticated LPs."
        />
      </section>
