...
import { Search, Lightbulb, Palette, Building2, Presentation, FileText, Briefcase, TrendingUp, Users } from 'lucide-react';
...
const services = [
  {
    title: 'Pitch Decks',
    description: 'Compelling investor presentations that articulate your brand story and growth potential with clarity and impact.',
    icon: Presentation
  },
  {
    title: 'Brand Presentations',
    description: 'Professional brand materials that showcase your unique value proposition to investors and partners.',
    icon: Briefcase
  },
  {
    title: 'Investor Updates',
    description: 'Clear and impactful investor update presentations that maintain and strengthen relationships.',
    icon: FileText
  },
  {
    title: 'Expansion Plans',
    description: 'Strategic expansion materials that communicate your growth roadmap and market opportunity.',
    icon: Building2
  },
  {
    title: 'Board Materials',
    description: 'Professional board presentations and committee materials that impress stakeholders.',
    icon: Users
  },
  {
    title: 'Financial Presentations',
    description: 'Comprehensive financial presentations that provide transparency and build investor confidence.',
    icon: TrendingUp
  }
];
...
export const FoodAndBeverageIndustryPage = () => {
    ...
    <div style={{
      ...
      <section style={{
        ...
        <div style={{
          ...
          <h1 style={{
            ...
            Pitch Decks That Showcase Your Flavor
          </h1>
          <span style={{
            color: 'rgba(124, 124, 124, 1)',
            fontSize: '18px',
            ...
            Compelling presentations that help food and beverage brands attract investors, expand distribution, and grow their culinary vision.
          </span>
          <button style={{
            width: 'auto',
            height: 'auto',
      ...
      <section style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            Built for Food Industry Leaders
          </h2>
        </div>
        <div style={{
          display: 'grid',
          ...
          <FeatureCard
            ...
            description="Marketing and investor materials that showcase your unique brand story and product differentiation."
            icon={Search}
          />
          <FeatureCard
            title="Market Expansion"
            description="Get presentations that communicate your growth strategy and market opportunity with precision."
            icon={FileText}
          />
          <FeatureCard
            title="Investor Confidence"
            description="From new product launches to fundraises. Get materials built for every stage."
            icon={Palette}
          />
        </div>
      </section>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <h3 style={{
                ...
                In food and beverage, your story is your brand
              </h3>
              <p style={{
                color: 'rgba(124, 124, 124, 1)',
                fontSize: '16px',
                ...
                Investors want to taste your vision. Your pitch deck should communicate why your brand deserves a place on every shelf. Request samples to see what professional food industry materials look like.
              </p>
              <button style={{
                width: 'auto',
                height: 'auto',
      ...
      <section style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            Turn Your Brand Vision Into Presentations That Close
          </h2>
          <p style={{
            color: 'rgba(124, 124, 124, 1)',
            fontSize: '18px',
            ...
            Leading food brands that attracted major investment. Companies that expanded globally. When the stakes are high, sophisticated firms choose materials that actually work.
          </p>
        </div>
        <div style={{
          display: 'grid',
          ...
          {[
            {
              ...
              items: ['Market Sizing & Analysis', 'Consumer Insights', 'Competitive Landscape', 'Distribution Analysis'],
              icon: Search,
              color: '#3b82f6',
            ...
            {
              title: 'Strategy',
              desc: 'Brand strategies built on logic and clarity. Messaging frameworks that articulate value.',
              items: ['Brand Positioning', 'Growth Strategy', 'Value Proposition Design', 'Investor Targeting'],
              icon: Lightbulb,
              color: '#f97316',
            ...
            {
              title: 'Design',
              desc: 'Sophisticated visuals that match your brand. Complex ideas transformed into clear presentations.',
              items: ['Pitch Deck Creation', 'Brand Guidelines', 'Data Visualization', 'Print-Ready Materials'],
              icon: Palette,
              color: '#a855f7',
      ...
      <section style={{
        ...
        <FAQItem
          ...
          answer="We serve sophisticated food and beverage companies including emerging brands, established manufacturers, restaurant groups, and CPG companies. Our clients typically require investor-ready materials for capital raising, brand development, and business growth."
        />
        <FAQItem
          question="What services do you offer?"
          answer="We offer a comprehensive suite of financial communication services including pitch decks, investor presentations, brand materials, board presentations, case studies, and brand development for food and beverage firms."
        />
        <FAQItem
          question="How do you ensure quality and confidentiality?"
          answer="We maintain strict confidentiality protocols and have NDAs in place for all client work. Our team has extensive experience working with sensitive financial information and industry-specific standards."
        />
        <FAQItem
      ...
      <section style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            Your Next Investment Starts With a Better Deck
          </h2>
          <p style={{
            color: 'rgba(124, 124, 124, 1)',
            ...
            Great brands deserve great storytelling. Don't let a weak deck cost you your next round.
          </p>
          <button style={{
            backgroundColor: COLORS.white,
            padding: '16px 24px',
