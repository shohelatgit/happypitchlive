  ...
  return (
    <div style={{
      ...
      <section style={{
        ...
        <div style={{
          ...
          <h1 style={{
            ...
            CIMs That Maximize Transaction Value
          </h1>
          <span style={{
            color: 'rgba(124, 124, 124, 1)',
            fontSize: '18px',
            ...
            Comprehensive sell-side materials that present your business opportunity with depth, polish, and strategic insight.
          </span>
          <button style={{
            width: 'auto',
            height: 'auto',
      ...
      <section style={{
        ...
        <div style={{
          ...
          <FeatureCard
            ...
            description="CIMs designed specifically for strategic buyers and financial sponsors, highlighting what matters to them."
            icon={Building2}
          />
          <FeatureCard
            title="Deep Business Intelligence"
            description="Comprehensive analysis of operations, financials, market position, and growth opportunities."
            icon={Search}
          />
          <FeatureCard
            title="Value Drivers Highlighted"
            description="Strategic narrative that showcases synergies, upside potential, and competitive advantages."
            icon={Lightbulb}
          />
          <FeatureCard
            title="Professional Excellence"
            description="Institutional-grade materials that command attention and reflect transaction value."
            icon={Palette}
          />
        </div>
      </section>
      ...
      <section style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            Turn Complex Businesses Into Compelling Opportunities
          </h2>
          <p style={{
            color: 'rgba(124, 124, 124, 1)',
            fontSize: '18px',
            ...
            CIMs that present your business in the best possible light, helping you command premium valuations and close faster.
          </p>
        </div>
        <div style={{
          display: 'grid',
          ...
          {[
            {
              title: 'Research',
              desc: 'Deep dive into your business to identify key value drivers and market opportunities.',
            ...
            {
              title: 'Strategy',
              desc: 'Positioning that highlights synergies and buyer value drivers.',
            ...
            {
              title: 'Design',
              desc: 'Professional documentation that reflects transaction value.',
      ...
      <section style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            CIMs that helped companies achieve premium valuations in M&A transactions.
          </p>
        </div>
        <div style={{
          width: '100%',
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{
                ...
                Happy Pitch created a CIM that truly captured our business value. The depth of analysis and professional presentation helped us achieve a premium valuation in our sale process.
              </p>
              <div style={{
                display: 'flex',
                flexDirection: 'column',
                ...
                <span style={{
                  ...
                  CEO, Industrial Manufacturing Co.
                </span>
              </div>
            </div>
            <div style={{
      ...
      <section style={{
        ...
        <FAQItem
          question="What industries do you create CIMs for?"
          answer="We have experience across technology, healthcare, manufacturing, professional services, consumer products, and financial services sectors."
        />
        <FAQItem
          question="How detailed are your CIMs?"
          answer="Our CIMs are comprehensive documents covering company overview, historical financials, market analysis, operations, management team, and growth opportunities."
        />
        <FAQItem
          question="Can you help with data room management?"
          answer="Yes, we can help organize and present additional due diligence materials in a professional, organized manner."
        />
        <FAQItem
          question="What makes your CIMs different?"
          answer="We combine deep business understanding with strategic positioning to create CIMs that highlight value drivers and command buyer attention."
        />
      </section>
      ...
      <section style={{
        ...
        <div style={{
          ...
          <button style={{
            ...
            Request Samples
            <img src="https://storage.googleapis.com/storage.magicpath.ai/user/374684919160512512/figma-assets/d01c1f21-4f2f-47a6-b750-15b4f0.svg"a88f76 alt="" style={{
              width: '24px'
            }} />
          </button>
        </div>
