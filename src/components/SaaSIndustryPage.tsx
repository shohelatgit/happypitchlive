...
import { Search, Lightbulb, Palette, Building2, Presentation, FileText, Briefcase, TrendingUp, Users, Megaphone } from 'lucide-react';
...
const services = [
  ...
  },
  {
    ...
    description: 'Compelling investor presentations that highlight your traction, market opportunity, and growth potential.',
    icon: FileText
  },
  {
  ...
  {
    title: 'Product Memos',
    description: 'Product messaging and technical presentations that communicate your solution effectively to all audiences.',
    icon: TrendingUp
  },
  {
    title: 'KPI Reporting',
    description: 'Data-driven KPI dashboards and reporting materials that demonstrate progress to investors and stakeholders.',
    icon: Users
  }
];
    ...
    <div style={{
      ...
      <section style={{
        ...
        <div style={{
          ...
          <h1 style={{
            ...
            Cloud Metrics That Convince Investors
          </h1>
          <span style={{
            color: 'rgba(124, 124, 124, 1)',
            fontSize: '18px',
            ...
            Compelling presentations that highlight your recurring revenue, retention metrics, and growth trajectory to investors.
          </span>
          <button style={{
            width: 'auto',
            height: 'auto',
      ...
      <section style={{
        ...
        <div style={{
          ...
          <FeatureCard
            title="MRR/ARR Clarity"
            description="Present your recurring revenue metrics in ways that investors immediately understand and trust."
            icon={TrendingUp}
          />
          <FeatureCard
            title="Retention & Engagement"
            description="Demonstrate your ability to retain customers and grow wallet share with compelling retention data."
            icon={Users}
          />
          <FeatureCard
            title="Growth Trajectory"
            description="Show your path to scale with projections and benchmarks that validate your business model."
            icon={Megaphone}
          />
        </div>
      </section>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <h3 style={{
                ...
                In SaaS, your metrics tell the story
              </h3>
              <p style={{
                color: 'rgba(124, 124, 124, 1)',
                fontSize: '16px',
                ...
                Investors in cloud companies look beyond revenue to unit economics, churn, and LTV. Your materials should make the numbers tell a compelling story.
              </p>
              <button style={{
                width: 'auto',
                height: 'auto',
      ...
      <section style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            Turn Your Metrics Into Presentations That Close
          </h2>
          <p style={{
            color: 'rgba(124, 124, 124, 1)',
            fontSize: '18px',
            ...
            SaaS companies that scaled to billions in valuation. Cloud businesses that achieved unicorn status. When the stakes are high, sophisticated firms choose materials that actually work.
          </p>
        </div>
        <div style={{
          display: 'grid',
          ...
          {[
            {
              ...
              items: ['Market Sizing', 'Competitive Analysis', 'Customer Segmentation', 'Industry Benchmarks'],
              icon: Search,
              color: '#3b82f6',
            ...
            },
            {
              ...
              items: ['Growth Strategy Development', 'Metric Selection', 'Investor Messaging', 'Board Presentation Strategy'],
              icon: Lightbulb,
              color: '#f97316',
            ...
            },
            {
              ...
              items: ['Pitch Deck Creation', 'Dashboard Design', 'Data Visualization', 'Infographics'],
              icon: Palette,
              color: '#a855f7',
