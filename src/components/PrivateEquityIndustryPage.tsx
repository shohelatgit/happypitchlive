...
import { Search, Lightbulb, Palette, Building2, Presentation, FileText, Briefcase, TrendingUp, Users, Landmark } from 'lucide-react';
...
const services = [
  {
    title: 'Pitch Decks',
    description: 'Compelling fundraise presentations that articulate your investment strategy and track record with clarity and impact.',
    icon: Presentation
  },
  {
    title: 'Fund Marketing',
    description: 'Institutional-grade marketing materials that position your fund for success with target LPs.',
    icon: FileText
  },
  {
    title: 'LP Presentations',
    description: 'Investor update presentations that maintain and strengthen relationships with limited partners.',
    icon: Briefcase
  },
  {
    title: 'Investment Memos',
    description: 'Investment memoranda that articulate your thesis, demonstrate track record, and build confidence.',
    icon: Building2
  },
  {
  ...
  {
    title: 'Due Diligence',
    description: 'Comprehensive due diligence materials that provide transparency and build trust with investors.',
    icon: TrendingUp
  }
];
...
export const PrivateEquityIndustryPage = () => {
    ...
    <div style={{
      ...
      <section style={{
        ...
        <div style={{
          ...
          <h1 style={{
            ...
            Compelling Fund Materials That Close Deals
          </h1>
          <span style={{
            color: 'rgba(124, 124, 124, 1)',
            fontSize: '18px',
            ...
            Institutional-grade presentations that help private equity firms raise capital, win investors, and grow their funds.
          </span>
          <button style={{
            width: 'auto',
            height: 'auto',
      ...
      <section style={{
        ...
        <div style={{
          ...
          <FeatureCard
            title="Proven Fund Performance"
            description="Marketing and investor materials that demonstrate your track record."
            icon={Search}
          />
          <FeatureCard
            title="LP Engagement Excellence"
            description="Get reports and presentations that communicate performance, strategy, and outcomes with precision."
            icon={FileText}
          />
          <FeatureCard
            title="Investment Committee Excellence"
            description="From fund launches to co-investments. Get materials built for every stage."
            icon={Palette}
          />
        </div>
      </section>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <h3 style={{
                ...
                In private equity, credibility is everything
              </h3>
              <p style={{
                color: 'rgba(124, 124, 124, 1)',
                fontSize: '16px',
                ...
                LP investors expect institutional-grade materials. Your pitch deck is a reflection of your fund's operational quality. Request samples to see what institutional-grade collateral looks like.
              </p>
              <button style={{
                width: 'auto',
                height: 'auto',
      ...
      <section style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            Turn Your Fund Story Into Presentations That Close
          </h2>
          <p style={{
            color: 'rgba(124, 124, 124, 1)',
            fontSize: '18px',
            ...
            Top-tier PE firms that raised billions. GPs that built lasting LP relationships. When the stakes are high, sophisticated firms choose materials that actually work.
          </p>
        </div>
        <div style={{
          display: 'grid',
          ...
          {[
            {
              ...
              items: ['Fund Performance Analysis', 'LP Database Research', 'Industry Sector Analysis', 'Fund Comparison Studies'],
              icon: Search,
              color: '#3b82f6',
            ...
            },
            {
              ...
              items: ['Investment Thesis Development', 'Fund Positioning', 'Value Creation Narrative', 'LP Targeting Strategy'],
              icon: Lightbulb,
              color: '#f97316',
