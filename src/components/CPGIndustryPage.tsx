...
import { Search, Lightbulb, Palette, Building2, Presentation, FileText, Briefcase, TrendingUp, Users, ShoppingCart } from 'lucide-react';
...
const services = [
  {
    title: 'Pitch Decks',
    description: 'Investor-ready presentations that articulate your brand story and commercial potential with clarity and impact.',
    icon: Presentation
  },
  {
    title: 'Brand Presentations',
    description: 'Compelling brand materials that showcase your products, market position, and growth potential.',
    icon: Building2
  },
  {
    title: 'Retailer Pitches',
    description: 'Trade presentations that get your products on shelves and into consumers hands.',
    icon: ShoppingCart
  },
  {
    title: 'Investor Memos',
    description: 'Investment materials that articulate your thesis and build confidence with investors.',
    icon: FileText
  },
  {
    title: 'Board Materials',
    description: 'Professional board presentations that impress stakeholders and drive strategic decisions.',
    icon: Briefcase
  },
  {
    title: 'Trade Marketing',
    description: 'Retail-ready materials that support your distribution and merchandising strategy.',
    icon: TrendingUp
  }
];
  ...
  return (
    <div style={{
      ...
      <section style={{
        ...
        <div style={{
          ...
          <h1 style={{
            ...
            Brand Presentations That Win Shelf Space
          </h1>
          <span style={{
            color: 'rgba(124, 124, 124, 1)',
            fontSize: '18px',
            ...
            Compelling materials that help CPG brands attract retailers, distributors, and investors to fuel growth.
          </span>
          <button style={{
            width: 'auto',
            height: 'auto',
      ...
      <section style={{
        ...
        <div style={{
          ...
          <FeatureCard
            ...
            description="We craft compelling brand narratives that resonate with retailers and investors alike."
            icon={ShoppingCart}
          />
          <FeatureCard
            title="Consumer Reach"
            description="Present your market penetration and consumer loyalty metrics with clarity and impact."
            icon={TrendingUp}
          />
          <FeatureCard
            title="Distribution Strategy"
            description="Showcase your retail network and expansion strategy with professional materials."
            icon={Building2}
          />
        </div>
      </section>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <h3 style={{
                ...
                In CPG, presentation drives purchase
              </h3>
              <p style={{
                color: 'rgba(124, 124, 124, 1)',
                fontSize: '16px',
                ...
                Retailers and investors judge brands by their polish and promise. Your materials should showcase consumer appeal and commercial viability.
              </p>
              <button style={{
                width: 'auto',
                height: 'auto',
      ...
      <section style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            Turn Your Brand Into Presentations That Close
          </h2>
          <p style={{
            color: 'rgba(124, 124, 124, 1)',
            fontSize: '18px',
            ...
            CPG brands that dominate categories. Companies that became household names. When the stakes are high, sophisticated firms choose materials that actually work.
          </p>
        </div>
        <div style={{
          display: 'grid',
          ...
          {[
            {
              ...
              items: ['Category Analysis', 'Consumer Insights', 'Competitive Landscape', 'Market Sizing'],
              icon: Search,
              color: '#3b82f6',
            ...
            },
            {
              ...
              items: ['Brand Positioning', 'Trade Strategy', 'Pricing Strategy', 'Distribution Planning'],
              icon: Lightbulb,
              color: '#f97316',
            ...
            },
            {
              ...
              items: ['Pitch Deck Creation', 'Brand Guidelines', 'Trade Materials', 'Presentation Design'],
              icon: Palette,
              color: '#a855f7',
      ...
      <section style={{
        ...
        <FAQItem
          question="What types of CPG clients do you work with?"
          answer="We work with consumer packaged goods companies across categories—from food and beverage to personal care and household products. Our clients include emerging brands seeking retail distribution and established companies launching new products."
        />
        <FAQItem
          question="What services do you offer for CPG brands?"
          answer="We offer pitch decks, brand presentations, retailer pitches, investor memos, board materials, and trade marketing materials specifically tailored for the CPG industry."
        />
        <FAQItem
          question="How do you help with retailer presentations?"
          answer="Our team understands what retailers look for in brand presentations—retail-ready materials that demonstrate consumer demand, margin opportunity, and marketing support."
        />
        <FAQItem
      ...
      <section style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            Your Next Launch Starts With a Better Deck
          </h2>
          <p style={{
            color: 'rgba(124, 124, 124, 1)',
            ...
            Great brands deserve great storytelling. Don't let a weak presentation cost you your next retail partnership.
          </p>
          <button style={{
            backgroundColor: COLORS.white,
            padding: '16px 24px',
